...
//    private ApplicationContext ctx = new ClassPathXmlApplicationContext("spring/spring_appservice.xml");

    @Before
    public void setUp() {
        userService = BeanService.getService(UserService.class);//(UserService)ctx.getBean("userservice");
//        userService = new DefaultUserService();
//        //FOR TEST
//        ((DefaultUserService) userService).setPlUserService(new DefaultPLUserService());
        removeAll();
    }
    ...
    public void tesQueryAll0() {
        final int oldsize = userService.queryAll().size();
        ...
        Assert.assertEquals(oldsize + addsize, userService.queryAll().size());
    }
    ...
    public void testQueryByName0() {
        ...
        Assert.assertTrue(userService.queryAll().size() == 10);
    ...
    public void testQueryByName2() {
        ...
        Assert.assertFalse(userService.queryByName("").isEmpty());
    }
